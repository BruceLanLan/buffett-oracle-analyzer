...
1. [核心投资哲学](#核心投资哲学)
2. [AGI时间线预测](#agi时间线预测)
3. [计算规模爆发：从千卡到百万卡](#计算规模爆发从千卡到百万卡)
4. [四大投资主题](#四大投资主题)
5. [市值估算框架](#市值估算框架)
6. [Aschenbrenner检查清单](#aschenbrenner检查清单)
7. [危险信号](#危险信号)
8. [经典语录](#经典语录)
...
- 这意味着需要从万卡GPU集群扩展到**百万卡集群**

### 递归自改进（Recursive Self-Improvement）
- AGI将具备改进自身代码的能力
- 一旦超越人类水平的AI能自主改进AI，增长将变为**超级指数**
- 时间线不是5-10年线性外推，而是**断崖式加速**
- 这是历史上从未有过的经济现象
...
### 投资推论
1. 只有超大规模玩家（MSFT, GOOG, AMZN, META）有资金能力
2. 半导体供应商（NVDA）是唯一瓶颈资源
3. 能源基础设施将成为新的稀缺资源
4. 垂直整合（芯片→云→应用）是最大护城河
...
1. **算力基础设施定位**：该公司在AGI计算堆栈中处于哪个层次？（芯片/云/模型/应用）
2. **资本配置信号**：管理层是否在大规模投资AI基础设施？Capex指引是否在上升？
3. **规模扩展路径**：能否从千卡扩展到百万卡？技术和资金障碍是什么？
4. **垂直整合程度**：是否控制全栈？从芯片设计到应用部署的整合度如何？
5. **国家安全维度**：是否受到出口管制/地缘政治影响？战略自主性如何？
6. **AGI时间线映射**：如果AGI 2027年到来，公司会因此变得多重要？
7. **与传统估值的冲突**：当前高PE是否合理？AGI的TAM扩张能否支撑估值？
