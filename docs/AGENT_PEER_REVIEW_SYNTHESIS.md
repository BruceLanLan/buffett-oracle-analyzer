...
| P2-4 | Unified OOS calibration pipeline (also: validate `_REGIME_ADJUSTMENTS` multipliers against a flat-weight baseline out-of-sample) | #3 | Pending |
