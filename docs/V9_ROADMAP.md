...
> 最后更新：2026-06-25，当前版本 **v10.16.7**（继续"数据不显示"排查到 Dashboard 剩余页面，修复历史页日历热力图和组合优化器 Sharpe/权重单位错误，2100 tests passing；v10.16.6 的投委会/深度报告 GIL 限制仍按用户决定保留为已知局限，详见下方叙事和 CHANGELOG）
